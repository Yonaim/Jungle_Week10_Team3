...
class UEditorEngine : public UEngine
{
  public:
    ...
    {
        return FEditorSettings::Get().CoordSystem == EEditorCoordSystem::World;
    }
    ...
    FEditorSettings &GetSettings()
    {
        return FEditorSettings::Get();
    }
    const FEditorSettings &GetSettings() const
    {
        return FEditorSettings::Get();
    }
