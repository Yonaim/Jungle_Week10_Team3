...
void FSkeletonTreePanel::Render(USkeletalMesh *Mesh, FSkeletalMeshEditorState &State, const char *WindowName, ImGuiID DockspaceId)
{
    if (DockspaceId != 0)
    {
    ...
    ImGui::SameLine();
    ImGui::TextDisabled("Bone Selection");
    ImGui::Separator();
